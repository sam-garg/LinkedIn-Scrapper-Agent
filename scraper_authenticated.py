...
def scroll_profile(page):
    print("\n[SCROLL] Scrolling through profile...")
    ...
    for i in range(1, 16):
        try:
            ...
            print(f"[SCROLL] Step {i}/15")

        except Exception as e:
            print("[SCROLL] Failed:", e)
            break

    # Give LinkedIn time to finish lazy-loading
    time.sleep(3)
    ...
    print("[SCROLL] Profile scrolling completed.")
